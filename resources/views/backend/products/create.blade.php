                ...
                <div class="form-row">
                    <div class="col-6">
                        ...
                        <input type="text" name="product_name" id="product_name"
                            ...
                            aria-describedby="helpId" value="{{ old('product_name') }}">
                        @error('product_name')
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" name="product_price" id="product_price"
                            ...
                            aria-describedby="helpId" value="{{ old('product_price') }}">
                        @error('product_price')
                            <div class="error">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-6">
                        ...
                        <input type="number" name="product_quantity" id="product_quantity"
                            ...
                            aria-describedby="helpId" value="{{ old('product_quantity') }}">
                ...
                <div class="form-row">
                    <div class="col-12">
                        ...
                        <textarea class="form-control @error('product_description') is-invalid @enderror form-control custom-file"
                            id="product_description" name="product_description" rows="3">{{ old('product_description') }}</textarea>
